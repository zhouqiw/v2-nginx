## v2ray-heroku
[![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/ZemlakFrieda/v2-nginx)
...
![image](https://github.com/zhouqiw/v2-nginx/tree/main/doc/1.png)

请求`/speedtest/`，html5-speedtest测速页面

![image](https://github.com/zhouqiw/v2-nginx/tree/main/doc/2.png)

请求`/test/`，文件下载速度测试

![image](https://github.com/zhouqiw/v2-nginx/tree/main/doc/3.png)
